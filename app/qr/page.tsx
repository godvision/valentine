...
export default function QRPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-pink-100 to-pink-200 p-8">
      ...
      <p className="text-pink-600 mt-6 text-lg text-center" style={{ fontFamily: "var(--font-quicksand)" }}>
        {SITE_URL}
      </p>
      
      <p className="text-pink-400 mt-4 text-sm text-center" style={{ fontFamily: "var(--font-quicksand)" }}>
